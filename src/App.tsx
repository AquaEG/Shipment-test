            ...
            <div className="rounded-[32px] border border-white/70 bg-white/85 p-6 shadow-soft backdrop-blur">
              ...
              <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
                <p>
                  ...
                  not inside component code. Set{' '}
                  <span className="font-mono text-slate-900">VITE_TRACKING_WEBHOOK_URL</span> and switch mock
                  mode off when your backend is ready.
                </p>
                <p>
